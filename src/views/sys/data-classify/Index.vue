<template>
  <PageWrapper title="数据分类管理">
    ...
    <Row :gutter="[16, 16]">
      ...
      <Col :span="12" v-auth="'sys:dataClassify:get'">
        <Card title="数据分类详情">
    ...
    <DataClassifyModal @register="registerModal" @success="handleSuccess" />
  </PageWrapper>
</template>
<script lang="ts">
  ...
  import {
    ...
    getApi,
    getTreeAsPromiseApi,
  } from '/@/api/sys/data-classify/DataClassify.api';
  import { descSchema } from '/@/views/sys/data-classify/DataClassify.data';
